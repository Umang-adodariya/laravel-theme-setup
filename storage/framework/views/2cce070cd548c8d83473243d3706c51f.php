    ...
    <div id="kt_app_content_container" class="app-container container-xxl">
        ...
        <div class="card card-flush py-4">
            ...
            <div id="kt_account_settings_profile_details" class="collapse show">
                <!--begin::Form-->
                <?php echo Form::open([ 'method' => 'POST', 'route' => ['admin-users.update', $user->id], 'id'=>'user_form', 'class' => 'form validate_form_role', 'enctype' => 'multipart/form-data' ]); ?>
                    ...
                    <div class="card-body border-top p-9">
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 fv-row">
                                        <input type="text" name="name" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Name" value="<?php echo e($user->name); ?>" data-parsley-required data-parsley-required-message="Please enter name" data-parsley-pattern= '^[a-zA-Z_ ]*$' data-parsley-pattern-message='Please add in correct name' ,data-parsley-trigger='keyup'/>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="email" name="email" class="form-control form-control-lg form-control-solid" placeholder="Email" value="<?php echo e($user->email); ?>"
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="row">
                                    <!--begin::Col-->
                                    <div class="col-lg-12 fv-row">
                                        <input name="phone_number" minimum="0"  class="form-control form-control-lg form-control-solid" type="digits" placeholder="Phone Number" value="<?php echo e($user->phone_number); ?>"
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                ...
                                <select name="role[]" aria-label="Select Role" data-control="select2" data-placeholder="Select role..." class="form-select form-select-solid form-select-lg " multiple required data-parsley-required-message="Please select role" data-parsley-errors-container='#role_error'>
                                    ...
                                    <option value="<?php echo e($role->name); ?>" <?php if(in_array($role->name, $userRole)): ?> selected <?php endif; ?>><?php echo e($role->name); ?></option>
...
<?php echo $__env->make('admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel-them\matkagambling\resources\views/users/edit.blade.php ENDPATH**/ ?>