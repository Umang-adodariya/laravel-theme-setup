        ...
        <div class="card card-flush py-4">
            ...
            <div class="card-body pt-5">
                ...
                <div class="fv-row mb-7 fv-plugins-icon-container">
                    ...
                    <label class="mt-3"><?php echo e(Form::checkbox('permission[]', $value->id, in_array($value->id, $rolePermissions) ? true : false, ['class' => 'form-check-input name','data-parsley-required'=>'true' ,'data-parsley-required-message'=>'Please Select Permission.','data-parsley-errors-container'=>'#permission_error','data-parsley-trigger'=> 'click'])); ?>
...
<?php echo $__env->make('admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel-them\matkagambling\resources\views/roles/edit.blade.php ENDPATH**/ ?>