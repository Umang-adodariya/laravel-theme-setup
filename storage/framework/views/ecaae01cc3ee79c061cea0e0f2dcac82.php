<div class="card mb-5 mb-xl-10">
        ...
        <div class="card-body border-top p-9">
            ...
            <div class="d-flex flex-wrap align-items-center">
                ...
                <div id="kt_signin_email_edit" class="flex-row-fluid d-none">
                    <!--begin::Form-->
                    <form id="validate_form_password" class="form" novalidate="novalidate" autocomplete="off" action="<?php echo e(route('update-password')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="row mb-1">
                            <div class="col-lg-4">
    ...
    <!--end::Content-->
</div><?php /**PATH C:\laravel-them\matkagambling\resources\views/profile/update-password-form.blade.php ENDPATH**/ ?>